...
//     // eslint-disable-next-line no-undef
//     itineraryPoints.forEach((line) =>
//       L.polyline(line, { color: "#4380c2" }).addTo(map)
//     );
...
//             </Typography>
//             <List>
//               {mapLocations.itinerary
//                 .concat(mapLocations.futureItinerary)
//                 .map((el) => (
//                   <ListItem
//                     alignItems="flex-start"
//                     key={el.name + el.dateVisited}
//                   >
//                     <ListItemAvatar
